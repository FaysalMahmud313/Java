...
public class EmployeeViewFrame extends JFrame implements ActionListener
{
	...
	private JButton transactionBtn, moneyTransferBtn,accountBtn, backBtn;
	private JPanel panel;
	private User u;
	
	public EmployeeViewFrame(User u)
	{
		
		super("Employee View Frame");
		...
		this.backgroundIcon = new ImageIcon("image/Employee View.jpg");
