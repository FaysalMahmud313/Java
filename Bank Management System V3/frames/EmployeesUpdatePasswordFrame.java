...
public class EmployeesUpdatePasswordFrame extends JFrame implements ActionListener
{
	...
	public EmployeesUpdatePasswordFrame(User u)
	{
		super("Employees Update Password ");
		...
		this.userTF.setBounds(175,50,100,30);
